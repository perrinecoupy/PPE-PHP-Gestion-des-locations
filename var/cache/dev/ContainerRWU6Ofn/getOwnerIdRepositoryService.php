 ...
 */
class getOwnerIdRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OwnerIdRepository' shared autowired service.
     *
     * @return \App\Repository\OwnerIdRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OwnerIdRepository.php';

        return $container->privates['App\\Repository\\OwnerIdRepository'] = new \App\Repository\OwnerIdRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
