 ...
 */
class getResidenceIdRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ResidenceIdRepository' shared autowired service.
     *
     * @return \App\Repository\ResidenceIdRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ResidenceIdRepository.php';

        return $container->privates['App\\Repository\\ResidenceIdRepository'] = new \App\Repository\ResidenceIdRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
