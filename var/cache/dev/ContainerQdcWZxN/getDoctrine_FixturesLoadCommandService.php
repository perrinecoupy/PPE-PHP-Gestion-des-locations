...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'AuthorFixtures.php';
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'RentFixtures.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'ResidenceFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\ArticleFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AuthorFixtures(), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\CategoryFixtures(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\RentFixtures(), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\ResidenceFixtures(), 'groups' => []], 5 => ['fixture' => new \App\DataFixtures\UserFixtures(), 'groups' => []]]);
