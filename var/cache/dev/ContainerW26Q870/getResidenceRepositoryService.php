 ...
 */
class getResidenceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ResidenceRepository' shared autowired service.
     *
     * @return \App\Repository\ResidenceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ResidenceRepository.php';

        return $container->privates['App\\Repository\\ResidenceRepository'] = new \App\Repository\ResidenceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
