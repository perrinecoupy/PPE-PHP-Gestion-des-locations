    ...
    <div class=\"container\">
        <div class=\"row\">
            <div class=\"col-lg-6 col-xs-12\">
                ";
        // line 8
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 8, $this->source); })()), "arrival_date", [], "any", false, false, false, 8), 'row', ["attr" => ["class" => "form-control"]]);
        echo "
                ";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), "departure_date", [], "any", false, false, false, 9), 'row', ["attr" => ["class" => "form-control"]]);
        echo "
                ";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "id", [], "any", false, false, false, 10), 'row');
        echo "
                ";
        // line 11
...
";
    ...
    {
        return array (  96 => 15,  89 => 11,  85 => 10,  81 => 9,  77 => 8,  68 => 3,  58 => 2,  35 => 1,);
    }
