...
";
    ...
    {
        return array (  120 => 29,  114 => 25,  110 => 21,  103 => 17,  95 => 12,  91 => 11,  87 => 10,  83 => 9,  77 => 8,  68 => 3,  58 => 2,  35 => 1,);
    }
        ...
        <div class=\"container\">
            <div class=\"row\">
                ...
                <div class=\"form-row locations\">
                    ...
                    {# {% for residence in user.representativeResidences %}
                        {{ dump(residence.representativeResidences) }}
                    {% endfor %}#}
                </div>
            </div>
        </div>
